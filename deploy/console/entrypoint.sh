...
server {
  ...
  location ~* ^/(ai/connection|ai/tool|bff|health|definition|folder|identity-directory|inbound-trigger|instance|job|message|notifications|trigger|usertask|form-section|form|timer)(/|\$) {
