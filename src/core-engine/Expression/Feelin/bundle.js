...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27);
/* harmony import */ var _temporal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(32);
/* harmony import */ var luxon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
const builtins = {
    ...
    'date': fn(function (year, month, day, from) {
        if (!from && !(0,_types__WEBPACK_IMPORTED_MODULE_1__.isNumber)(year)) {
            from = year;
            year = null;
        }
        let d;
        if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isString)(from)) {
            d = (0,_temporal__WEBPACK_IMPORTED_MODULE_2__.date)(from);
        }
        if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isDateTime)(from)) {
            d = from;
        }
        if (year) {
            d = (0,_temporal__WEBPACK_IMPORTED_MODULE_2__.date)().setZone('utc').set({
                year,
                month,
                day
            });
    ...
    'date and time': fn(function (d, time, from) {
        let dt;
        if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isDateTime)(d) && (0,_types__WEBPACK_IMPORTED_MODULE_1__.isDateTime)(time)) {
        ...
        if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isString)(d)) {
            from = d;
            d = null;
        }
        if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isString)(from)) {
            dt = (0,_temporal__WEBPACK_IMPORTED_MODULE_2__.date)(from, null, from.includes('@') ? null : luxon__WEBPACK_IMPORTED_MODULE_0__.SystemZone.instance);
        }
    ...
    'time': fn(function (hour, minute, second, offset, from) {
        let t;
        if (offset) {
            throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('time(..., offset)');
        }
        if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isString)(hour) || (0,_types__WEBPACK_IMPORTED_MODULE_1__.isDateTime)(hour)) {
            from = hour;
            hour = null;
        }
        if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isString)(from)) {
            t = (0,_temporal__WEBPACK_IMPORTED_MODULE_2__.date)(null, from);
        }
        if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isDateTime)(from)) {
            t = from.set({
                year: 1900,
        ...
        if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isNumber)(hour)) {
            // TODO: support offset = days and time duration
            t = (0,_temporal__WEBPACK_IMPORTED_MODULE_2__.date)().set({
                hour,
                minute,
                second
            }).set({
    ...
    'duration': fn(function (from) {
        return ifValid((0,_temporal__WEBPACK_IMPORTED_MODULE_2__.duration)(from));
    }, ['string']),
    ...
    '@': fn(function (string) {
        let t;
        if (/^-?P/.test(string)) {
            t = (0,_temporal__WEBPACK_IMPORTED_MODULE_2__.duration)(string);
        }
        else if (/^[\d]{1,2}:[\d]{1,2}:[\d]{1,2}/.test(string)) {
            t = (0,_temporal__WEBPACK_IMPORTED_MODULE_2__.date)(null, string);
        }
        else {
            t = (0,_temporal__WEBPACK_IMPORTED_MODULE_2__.date)(string);
        }
        return t && ifValid(t) || null;
    }, ['string']),
    'now': fn(function () {
        return (0,_temporal__WEBPACK_IMPORTED_MODULE_2__.date)();
    }, []),
    'today': fn(function () {
        return (0,_temporal__WEBPACK_IMPORTED_MODULE_2__.date)().startOf('day');
    }, []),
    // 10.3.4.2 Boolean function
    'not': fn(function (bool) {
        return (0,_types__WEBPACK_IMPORTED_MODULE_1__.isType)(bool, 'boolean') ? !bool : null;
    }, ['any']),
    // 10.3.4.3 String functions
    ...
    'matches': fn(function (input, pattern, flags) {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('matches');
    ...
    'string join': fn(function (list, delimiter) {
        if (list.some(e => !(0,_types__WEBPACK_IMPORTED_MODULE_1__.isString)(e) && e !== null)) {
            return null;
        }
    ...
    'list replace': fn(function (list, position, newItem, match) {
        ...
        if (!['number', 'function'].includes((0,_types__WEBPACK_IMPORTED_MODULE_1__.getType)(matcher))) {
            return null;
        }
    ...
    'union': listFn(function (...lists) {
        return lists.reduce((result, list) => {
            return list.reduce((result, e) => {
                if (!result.some(r => (0,_types__WEBPACK_IMPORTED_MODULE_1__.equals)(e, r))) {
                    result.push(e);
                }
                return result;
            }, result);
    ...
    'round up': fn(function (n, scale) {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('round up');
    }, ['number', 'number']),
    // eslint-disable-next-line
    'round down': fn(function (n, scale) {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('round down');
    }, ['number', 'number']),
    // eslint-disable-next-line
    'round half up': fn(function (n, scale) {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('round half up');
    }, ['number', 'number']),
    // eslint-disable-next-line
    'round half down': fn(function (n, scale) {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('round half down');
    }, ['number', 'number']),
    ...
    'is': fn(function (value1, value2) {
        ...
        return (0,_types__WEBPACK_IMPORTED_MODULE_1__.equals)(value1, value2, true);
    }, ['any?', 'any?']),
    // 10.3.4.7 Range Functions
    ...
    'overlaps before': fn(function () {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('overlaps before');
    }, ['any?']),
    'overlaps after': fn(function () {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('overlaps after');
    }, ['any?']),
    'finishes': fn(function () {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('finishes');
    }, ['any?']),
    'finished by': fn(function () {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('finished by');
    }, ['any?']),
    'includes': fn(function () {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('includes');
    }, ['any?']),
    'during': fn(function () {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('during');
    }, ['any?']),
    'starts': fn(function () {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('starts');
    }, ['any?']),
    'started by': fn(function () {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('started by');
    }, ['any?']),
    'coincides': fn(function () {
        throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('coincides');
    }, ['any?']),
    // 10.3.4.8 Temporal built-in functions
    ...
    'get value': fn(function (m, key) {
        return (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getFromContext)(key, m) || null;
    }, ['context', 'string']),
...
function contextPut(context, keys, value) {
    ...
    if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.getType)(key) !== 'string') {
        return null;
    }
    if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.getType)(context) === 'nil') {
        return null;
    }
...
function createArgTester(arg) {
    ...
    return function (obj) {
        ...
        const objType = (0,_types__WEBPACK_IMPORTED_MODULE_1__.getType)(obj);
        ...
        return (0,_types__WEBPACK_IMPORTED_MODULE_1__.typeCast)(obj, type) || FALSE;
    };
}
...
function listFn(fnDefinition, type, parameterNames = null) {
    ...
    wrappedFn.$args = parameterNames || (0,_utils__WEBPACK_IMPORTED_MODULE_3__.parseParameterNames)(fnDefinition);
    return wrappedFn;
}
/**
 * @param {Function} fnDefinition
...
function fn(fnDefinition, argDefinitions, parameterNames = null) {
    ...
    parameterNames = parameterNames || (0,_utils__WEBPACK_IMPORTED_MODULE_3__.parseParameterNames)(fnDefinition);
    const wrappedFn = function (...args) {
 ...
 */
function before(a, b) {
    if (a instanceof _types__WEBPACK_IMPORTED_MODULE_1__.Range && b instanceof _types__WEBPACK_IMPORTED_MODULE_1__.Range) {
        return (a.end < b.start || (!a['end included'] || !b['start included']) && a.end == b.start);
    }
    if (a instanceof _types__WEBPACK_IMPORTED_MODULE_1__.Range) {
        return (a.end < b || (!a['end included'] && a.end === b));
    }
    if (b instanceof _types__WEBPACK_IMPORTED_MODULE_1__.Range) {
...
function toString(obj, wrap = false) {
    var _a, _b, _c, _d;
    const type = (0,_types__WEBPACK_IMPORTED_MODULE_1__.getType)(obj);
    if (type === 'nil') {
        return 'null';
    }
    if (type === 'string') {
    ...
    throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('string(' + type + ')');
}
...
function listReplace(list, matcher, newItem) {
    if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isNumber)(matcher)) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FunctionWrapper: () => (/* binding */ FunctionWrapper),
...
/* harmony export */   typeCast: () => (/* binding */ typeCast)
/* harmony export */ });
/* harmony import */ var luxon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
/* harmony export */ });
/* harmony import */ var _datetime_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _duration_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
/* harmony import */ var _interval_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(22);
/* harmony import */ var _info_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(23);
/* harmony import */ var _zone_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13);
/* harmony import */ var _zones_fixedOffsetZone_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(17);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(14);
/* harmony import */ var _zones_invalidZone_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(18);
/* harmony import */ var _zones_systemZone_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(12);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(11);
...
/* harmony export */ });
/* harmony import */ var _duration_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony import */ var _interval_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(22);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _info_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(23);
/* harmony import */ var _impl_formatter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);
/* harmony import */ var _zones_fixedOffsetZone_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(17);
/* harmony import */ var _impl_locale_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(15);
/* harmony import */ var _impl_util_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(10);
/* harmony import */ var _impl_zoneUtil_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(16);
/* harmony import */ var _impl_diff_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(24);
/* harmony import */ var _impl_regexParser_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(21);
/* harmony import */ var _impl_tokenParser_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(25);
/* harmony import */ var _impl_conversions_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(19);
/* harmony import */ var _impl_formats_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(9);
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(6);
/* harmony import */ var _impl_invalid_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(20);
...
/* harmony export */ });
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
/* harmony import */ var _impl_formatter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
/* harmony import */ var _impl_invalid_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(20);
/* harmony import */ var _impl_locale_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15);
/* harmony import */ var _impl_regexParser_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(21);
/* harmony import */ var _impl_util_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(10);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(11);
/* harmony import */ var _datetime_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4);
...
/* harmony export */ });
/* harmony import */ var _english_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
/* harmony import */ var _formats_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
...
/* harmony export */ });
/* harmony import */ var _formats_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
...
/* harmony export */ });
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
/* harmony import */ var _conversions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(19);
/*
...
/* harmony export */ });
/* harmony import */ var _zones_systemZone_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);
/* harmony import */ var _impl_locale_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
/* harmony import */ var _impl_zoneUtil_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(16);
/* harmony import */ var _impl_util_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10);
...
/* harmony export */ });
/* harmony import */ var _impl_util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
/* harmony import */ var _zone_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
...
/* harmony import */ var _english_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _datetime_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14);
...
/* harmony export */ });
/* harmony import */ var _zone_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);
/* harmony import */ var _zones_fixedOffsetZone_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17);
/* harmony import */ var _zones_invalidZone_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(18);
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(10);
/* harmony import */ var _zones_systemZone_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(12);
/**
 * @private
 */
...
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
/* harmony import */ var _invalid_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(20);
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
...
/* harmony import */ var _english_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8);
/* harmony import */ var _zones_fixedOffsetZone_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
...
/* harmony import */ var _duration_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
/* harmony import */ var _settings_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
/* harmony import */ var _impl_invalid_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(20);
/* harmony import */ var _impl_formatter_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7);
/* harmony import */ var _impl_formats_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9);
...
/* harmony import */ var _impl_locale_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
/* harmony import */ var _impl_zoneUtil_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16);
/* harmony import */ var _impl_util_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(10);
...
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
/* harmony import */ var _formatter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
/* harmony import */ var _zones_fixedOffsetZone_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17);
/* harmony import */ var _zones_IANAZone_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
/* harmony import */ var _datetime_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4);
/* harmony import */ var _digits_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(26);
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getFromContext: () => (/* binding */ getFromContext),
/* harmony export */   notImplemented: () => (/* binding */ notImplemented),
/* harmony export */   parseParameterNames: () => (/* binding */ parseParameterNames)
/* harmony export */ });
/* harmony import */ var lezer_feel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28);
...
function getFromContext(name, context) {
    if (['nil', 'boolean', 'number', 'string'].includes((0,_types__WEBPACK_IMPORTED_MODULE_0__.getType)(context))) {
        return undefined;
    }
    if (name in context) {
        return context[name];
...
/* harmony export */ });
/* harmony import */ var _lezer_lr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29);
/* harmony import */ var _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(31);
...
/* harmony export */ });
/* harmony import */ var _lezer_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30);
...
/* harmony export */   isDateTime: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_1__.isDateTime),
/* harmony export */   isDuration: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_1__.isDuration),
...
function ms(temporal) {
    if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isDateTime)(temporal)) {
        return temporal.valueOf();
    }
    if ((0,_types__WEBPACK_IMPORTED_MODULE_1__.isDuration)(temporal)) {
        return temporal.valueOf();
    }
    return null;
}
...
function date(str = null, time = null, zone = null) {
    ...
    if (typeof str === 'string') {
        if (str.startsWith('-')) {
            throw (0,_utils__WEBPACK_IMPORTED_MODULE_2__.notImplemented)('negative date');
        }
        if (!str.includes('T')) {
...
/* harmony export */ });
/* harmony import */ var _builtins__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1);
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27);
/* harmony import */ var _parser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(34);
/* harmony import */ var luxon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
class Interpreter {
    ...
    evaluate(expression, context = {}) {
        const parseTree = (0,_parser__WEBPACK_IMPORTED_MODULE_1__.parseExpression)(expression, context);
    ...
    unaryTest(expression, context = {}) {
        const parseTree = (0,_parser__WEBPACK_IMPORTED_MODULE_1__.parseUnaryTests)(expression, context);
        const root = this._buildExecutionTree(parseTree, expression);
        return {
            parseTree,
            root
    ...
    switch (node.name) {
        case 'ArithOp': return (context) => {
            const nullable = (op, types = ['number']) => (a, b) => {
                ...
                if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.isArray)(left)) {
                    return null;
                }
                if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.isArray)(right)) {
                    return null;
                }
                const leftType = (0,_types__WEBPACK_IMPORTED_MODULE_2__.getType)(left);
                const rightType = (0,_types__WEBPACK_IMPORTED_MODULE_2__.getType)(right);
            ...
            switch (input) {
                case '+': return nullable((a, b) => {
                    if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.isType)(a, 'time') && (0,_types__WEBPACK_IMPORTED_MODULE_2__.isDuration)(b)) {
                        return a.plus(b).set({
                            year: 1900,
                            month: 1,
                            day: 1
                    ...
                    else if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.isDateTime)(a) && (0,_types__WEBPACK_IMPORTED_MODULE_2__.isDateTime)(b)) {
                        return null;
                    }
                    else if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.isDateTime)(a) && (0,_types__WEBPACK_IMPORTED_MODULE_2__.isDuration)(b)) {
                        return a.plus(b);
                    }
                    else if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.isDuration)(a) && (0,_types__WEBPACK_IMPORTED_MODULE_2__.isDuration)(b)) {
                        return a.plus(b);
                    }
                    return a + b;
        ...
        case 'CompareOp': return tag(() => {
            switch (input) {
                ...
                case '=': return (b) => (a) => (0,_types__WEBPACK_IMPORTED_MODULE_2__.equals)(a, b);
                case '!=': return (b) => (a) => !(0,_types__WEBPACK_IMPORTED_MODULE_2__.equals)(a, b);
            }
        }, Test('boolean'));
        ...
        case 'VariableName': return (context) => {
            ...
            const contextValue = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getFromContext)(name, context);
        ...
        case '?': return (context) => (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getFromContext)('?', context);
        // expression
        ...
        case 'InExpressions': return (context) => {
            ...
            if (iterationContexts.some(ctx => (0,_types__WEBPACK_IMPORTED_MODULE_2__.getType)(ctx) !== 'list')) {
                return null;
            }
            return cartesianProduct(iterationContexts).map(ctx => {
                if (!(0,_types__WEBPACK_IMPORTED_MODULE_2__.isArray)(ctx)) {
                    ctx = [ctx];
                }
        ...
        case 'SpecialType': throw (0,_utils__WEBPACK_IMPORTED_MODULE_3__.notImplemented)('SpecialType');
        ...
        case 'every': return tag((context) => {
            return (_contexts, _condition) => {
                ...
                if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.getType)(contexts) !== 'list') {
                    return contexts;
                }
        ...
        case 'ForExpression': return (context) => {
            ...
            if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.getType)(iterationContexts) !== 'list') {
        ...
        case 'PathExpression': return (context) => {
            ...
            if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.isArray)(pathTarget)) {
        ...
        case 'FilterExpression': return (context) => {
            ...
            const filterTarget = (0,_types__WEBPACK_IMPORTED_MODULE_2__.isArray)(target) ? target : [target];
            // null[..]
            if (target === null) {
                return null;
            }
            ...
            if (typeof filterFn.type === 'undefined') {
                try {
                    ...
                    if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.isNumber)(value)) {
            ...
            return filterTarget.map(el => {
                ...
                if (result instanceof _types__WEBPACK_IMPORTED_MODULE_2__.Range) {
        ...
        case 'UnaryTests': return (context) => {
            return (value = null) => {
                ...
                const matches = tests.map(test => test(context)).flat(1).map(test => {
                    if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.isArray)(test)) {
...
function getBuiltin(name, _context) {
    return (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getFromContext)(name, _builtins__WEBPACK_IMPORTED_MODULE_4__.builtins);
}
function extractValue(context, prop, _target) {
    const target = _target(context);
    if (['list', 'range'].includes((0,_types__WEBPACK_IMPORTED_MODULE_2__.getType)(target))) {
        return target.map(t => ({ [prop]: t }));
    }
    return null;
}
function compareIn(value, tests) {
    if (!(0,_types__WEBPACK_IMPORTED_MODULE_2__.isArray)(tests)) {
        if ((0,_types__WEBPACK_IMPORTED_MODULE_2__.getType)(tests) === 'nil') {
            return null;
        }
        tests = [tests];
    }
...
function compareValue(test, value) {
    ...
    if (test instanceof _types__WEBPACK_IMPORTED_MODULE_2__.Range) {
        return test.includes(value);
    }
    return (0,_types__WEBPACK_IMPORTED_MODULE_2__.equals)(test, value);
}
const chars = Array.from('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ');
function isTyped(type, values) {
    return (values.some(e => (0,_types__WEBPACK_IMPORTED_MODULE_2__.getType)(e) === type) &&
        values.every(e => e === null || (0,_types__WEBPACK_IMPORTED_MODULE_2__.getType)(e) === type));
}
const nullRange = new _types__WEBPACK_IMPORTED_MODULE_2__.Range({
    start: null,
    end: null,
...
function createStringRange(start, end, startIncluded = true, endIncluded = true) {
    ...
    return new _types__WEBPACK_IMPORTED_MODULE_2__.Range({
        start,
        end,
...
function cartesianProduct(arrays) {
    if (arrays.some(arr => (0,_types__WEBPACK_IMPORTED_MODULE_2__.getType)(arr) === 'nil')) {
        return null;
    }
...
function wrapFunction(fn, parameterNames = null) {
    ...
    if (fn instanceof _types__WEBPACK_IMPORTED_MODULE_2__.FunctionWrapper) {
        return fn;
    }
    if (fn instanceof _types__WEBPACK_IMPORTED_MODULE_2__.Range) {
        return new _types__WEBPACK_IMPORTED_MODULE_2__.FunctionWrapper((value) => fn.includes(value), ['value']);
    }
    if (typeof fn !== 'function') {
        return null;
    }
    return new _types__WEBPACK_IMPORTED_MODULE_2__.FunctionWrapper(fn, parameterNames || (0,_utils__WEBPACK_IMPORTED_MODULE_3__.parseParameterNames)(fn));
}
...
/* harmony export */ });
/* harmony import */ var lezer_feel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(28);

function parseExpression(expression, context = {}) {
    return lezer_feel__WEBPACK_IMPORTED_MODULE_0__.parser.configure({
        top: 'Expression',
        contextTracker: (0,lezer_feel__WEBPACK_IMPORTED_MODULE_0__.trackVariables)(context)
    }).parse(expression);
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FunctionWrapper: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_4__.FunctionWrapper),
/* harmony export */   Range: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_4__.Range),
/* harmony export */   SyntaxError: () => (/* reexport safe */ _interpreter__WEBPACK_IMPORTED_MODULE_1__.SyntaxError),
/* harmony export */   builtins: () => (/* reexport safe */ _builtins__WEBPACK_IMPORTED_MODULE_0__.builtins),
/* harmony export */   date: () => (/* reexport safe */ _temporal__WEBPACK_IMPORTED_MODULE_3__.date),
/* harmony export */   duration: () => (/* reexport safe */ _temporal__WEBPACK_IMPORTED_MODULE_3__.duration),
/* harmony export */   equals: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_4__.equals),
/* harmony export */   evaluate: () => (/* reexport safe */ _interpreter__WEBPACK_IMPORTED_MODULE_1__.evaluate),
/* harmony export */   getFromContext: () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_5__.getFromContext),
/* harmony export */   getType: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_4__.getType),
/* harmony export */   isArray: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_4__.isArray),
/* harmony export */   isBoolean: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_4__.isBoolean),
/* harmony export */   isContext: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_4__.isContext),
/* harmony export */   isDateTime: () => (/* reexport safe */ _temporal__WEBPACK_IMPORTED_MODULE_3__.isDateTime),
/* harmony export */   isDuration: () => (/* reexport safe */ _temporal__WEBPACK_IMPORTED_MODULE_3__.isDuration),
/* harmony export */   isNumber: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_4__.isNumber),
/* harmony export */   isString: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_4__.isString),
/* harmony export */   isType: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_4__.isType),
/* harmony export */   lintError: () => (/* reexport safe */ _interpreter__WEBPACK_IMPORTED_MODULE_1__.lintError),
/* harmony export */   ms: () => (/* reexport safe */ _temporal__WEBPACK_IMPORTED_MODULE_3__.ms),
/* harmony export */   names: () => (/* reexport safe */ _builtins__WEBPACK_IMPORTED_MODULE_0__.names),
/* harmony export */   notImplemented: () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_5__.notImplemented),
/* harmony export */   parseExpression: () => (/* reexport safe */ _parser__WEBPACK_IMPORTED_MODULE_2__.parseExpression),
/* harmony export */   parseParameterNames: () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_5__.parseParameterNames),
/* harmony export */   parseUnaryTests: () => (/* reexport safe */ _parser__WEBPACK_IMPORTED_MODULE_2__.parseUnaryTests),
/* harmony export */   typeCast: () => (/* reexport safe */ _types__WEBPACK_IMPORTED_MODULE_4__.typeCast),
/* harmony export */   unaryTest: () => (/* reexport safe */ _interpreter__WEBPACK_IMPORTED_MODULE_1__.unaryTest)
/* harmony export */ });
/* harmony import */ var _builtins__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _interpreter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(33);
/* harmony import */ var _parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34);
/* harmony import */ var _temporal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(32);
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(27);
