    ...
    >
      ...
      <div className="flex flex-none items-center gap-[5px]">
        ...
        <button
          ...
          title="Benutzermenü"
          // Auf dem Telefon bleibt als sichtbarer Inhalt nur das Kürzel stehen. Der
          // explizite Name erklärt dort die Funktion und enthält zugleich den sichtbaren
          // Text; am großen Schirm bilden Kürzel und Rollenbezeichnung selbst den Namen.
          aria-label={compact ? `${user?.initials ?? '?'}, Benutzermenü` : undefined}
